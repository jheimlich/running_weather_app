...
function getEnhancedClothingRecommendations(
  ...
  if (effectiveTemp <= -5) {
    ...
    recommendations.top.push(
      "Thermal long-sleeve",
      "Insulated vest or light jacket"
    );
...
const GEAR_DATABASE: GearRecommendation[] = [
  {
    ...
    retailers: [
      {
        name: "Patagonia",
        link: "https://www.patagonia.com/product/mens-houdini-jacket/24142.html",
        price: "$99",
      },
      {
        name: "REI",
        link: "https://www.rei.com/product/118892/patagonia-houdini-jacket-mens",
        price: "$99",
      },
      {
        name: "Amazon",
        link: "https://amazon.com/dp/B00KQHQV7G",
        price: "$89",
      },
    ],
  },
  {
    ...
    retailers: [
      {
        name: "Smartwool",
        link: "https://www.smartwool.com/shop/merino-sport-fleece-training-glove-sw018092",
        price: "$40",
      },
      {
        name: "REI",
        link: "https://www.rei.com/product/191234/smartwool-merino-sport-fleece-training-gloves",
        price: "$40",
      },
      {
        name: "Amazon",
        link: "https://amazon.com/dp/B08XQJGQXY",
        price: "$35",
      },
    ],
  },
  {
    ...
    retailers: [
      {
        name: "Brooks",
        link: "https://www.brooksrunning.com/en_us/ghost-15-mens-road-running-shoe/110393.html",
        price: "$140",
      },
      {
        name: "Running Warehouse",
        link: "https://www.runningwarehouse.com/Brooks_Ghost_15/descpage-BG15M2.html",
        price: "$140",
      },
      {
        name: "Amazon",
        link: "https://amazon.com/dp/B09TP5QBQT",
        price: "$119",
      },
    ],
  },
  {
    ...
    brand: "Buff",
    price: "$35",
    description: "Versatile neck gaiter/hat/headband",
    conditions: ["cold", "very-cold", "windy"],
    retailers: [
      {
        name: "Buff",
        link: "https://www.buffusa.com/shop-buff/merino-wool",
        price: "$35",
      },
      {
        name: "REI",
        link: "https://www.rei.com/product/118181/buff-merino-wool-multifunctional-headwear",
        price: "$35",
      },
      {
        name: "Amazon",
        link: "https://amazon.com/dp/B015Q1Z6OK",
        price: "$32",
      },
    ],
  },
  {
    ...
    retailers: [
      {
        name: "Nathan",
        link: "https://nathansports.com/products/lightbender-rx-led-vest",
        price: "$30",
      },
      {
        name: "Running Warehouse",
        link: "https://www.runningwarehouse.com/Nathan_LightBender_RX_LED_Vest/descpage-NLBRV.html",
        price: "$30",
      },
      {
        name: "Amazon",
        link: "https://amazon.com/dp/B07QKJJQNK",
        price: "$28",
      },
    ],
  },
  {
    id: "outdoor-research-cap",
    name: "Swift Cap",
    brand: "Outdoor Research",
    price: "$28",
    description: "Water-resistant running cap with reflective trim",
    conditions: ["rain", "night"],
    retailers: [
      {
        name: "Outdoor Research",
        link: "https://www.outdoorresearch.com/us/swift-cap-243441",
        price: "$28",
      },
      {
        name: "REI",
        link: "https://www.rei.com/product/105819/outdoor-research-swift-cap",
        price: "$28",
      },
      {
        name: "Amazon",
        link: "https://amazon.com/dp/B06XWT3MJW",
        price: "$25",
      },
    ],
  },
...
function getGearRecommendations(
  ...
  const relevantGear = GEAR_DATABASE.filter(
    (item) =>
...
function generatePreRunChecklist(
  weather: WeatherData,
  runType: string,
  feelsLike: number,
  isNight: boolean,
  ...
  checklist.push({
    id: "hydration",
    text: isHot
      ? "Extra hydration (consider electrolytes)"
      : "Pre-hydrate (16-20oz water)",
  ...
  if (isLongRun || isWorkout) {
    checklist.push({
      id: "fuel",
      text: isLongRun
        ? "Fuel strategy planned (gels, snacks)"
        : "Light fuel if needed (banana, dates)",
      category: "performance",
      priority: "high",
      completed: false,
    });
...
export default function App() {
  ...
  useEffect(() => {
    if (weather) {
      ...
      const checklistItems = generatePreRunChecklist(
        weather,
        runType,
        weather.main.feels_like,
        isNight,
            ...
            >
              ...
              {!showGearSection && (
                <p style={{ margin: 0, opacity: 0.7, fontSize: "0.9rem" }}>
                  {gearRecommendations.length} products recommended for today's
                  conditions.
                </p>
              )}
              ...
              {showGearSection && (
                <div>
                  <div style={{ display: "grid", gap: "20px" }}>
                    {gearRecommendations.map((item) => (
                      ...
                      >
                        ...
                        >
                          {item.retailers.map((retailer, idx) => (
                            <a
                              key={idx}
                              href={retailer.link}
                              target="_blank"
                  ...
                  >
                    🤝 <strong>Transparency:</strong> These are affiliate links
                    that help support this free app. Prices and availability may
                    vary. Only gear we'd actually recommend for these
                    conditions.
                  </div>
                </div>
              )}
